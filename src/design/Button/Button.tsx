...
const Button = ({ children, onClick, secondary = false, asLink, href }: ButtonProps) => {
  ...
  if(asLink) {
    return (
      <HeadlessButton as="a" className={className} href={href} target="_blank" rel="noopener noreferrer">
        {children}
      </HeadlessButton>
    );
